...
function openCodeViewer() {
  ...
  overlay.querySelector(".code-viewer-sequence").textContent = (info.steps || ["// No instructions yet"]).join("\n");
  overlay.querySelector(".code-viewer-definitions pre").textContent = (info.operations || []).join("\n\n");
