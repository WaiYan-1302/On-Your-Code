(function () {
  ...
  const JA = {
    ...
    "Maro's Workshop 2 — Mini World Simulator": "マロのワークショップ2 — ミニワールドシミュレーター",
    "ON YOUR CODE · MARO'S WORKSHOP 2": "オン・ユア・コード・マロのワークショップ2",
    "Place things. Set the rules. Press play. See what kind of world you made.": "ものを置き、ルールを決めて、再生しよう。どんな世界ができるか観察してみよう。",
    "Idea Cards": "アイデアカード",
    "Pause": "一時停止",
    "Play": "再生",
    "Reset World": "世界をリセット",
    "Build the World": "世界を作る",
    "Click stage to place": "ステージを押して配置",
    "Plant": "植物を置く",
    "Grows food": "食べ物が実る",
    "Muncher": "マンチャー",
    "Looks for food": "食べ物を探す",
    "Drifter": "ドリフター",
    "Wanders around": "歩き回る",
    "Beacon": "ビーコン",
    "Attracts drifters": "ドリフターを引き寄せる",
    "Pond": "池",
    "Slows creatures": "クリーチャーを遅くする",
    "Erase": "消去",
    "Remove an item": "ものを取り除く",
    "World Rules": "世界のルール",
    "Surprise Me": "おまかせ",
    "Food grows every": "食べ物が実る間隔",
    "Creature speed": "クリーチャーの速さ",
    "Beacon pull": "ビーコンの引く力",
    "Off": "オフ",
    "Medium": "中",
    "Strong": "強",
    "When Maro gets close": "マロが近づいたとき",
    "Ignore Maro": "マロを無視する",
    "Follow Maro": "マロについていく",
    "Move Away": "離れる",
    "Garden": "ガーデン",
    "Busy World": "にぎやかな世界",
    "Quiet World": "静かな世界",
    "Your Little World": "あなたの小さな世界",
    "Move Maro with arrow keys / WASD. Place objects by choosing a tool, then clicking the stage.": "矢印キーまたはWASDでマロを動かせます。道具を選び、ステージを押してものを置こう。",
    "Day": "日",
    "Creatures": "クリーチャー",
    "Plants": "植物",
    "Food eaten": "食べた数",
    "Munchers lost": "死んだマンチャー",
    "Programming idea:": "プログラミングの考え方：",
    "You are not telling every creature where to go. You are deciding the rules they follow.": "すべてのクリーチャーへ行き先を命令するのではなく、行動するルールを決めています。",
    "World Notebook": "世界ノート",
    "Live": "実行中",
    "Can it survive?": "生き残れるかな？",
    "Try 2 plants and 5 munchers. Does everyone find enough food?": "植物2つとマンチャー5体を試そう。みんな十分な食べ物を見つけられるかな？",
    "Change one rule": "ルールを1つ変える",
    "Keep the same world, then change only food growth speed. What changes?": "同じ世界のまま、食べ物が育つ速さだけを変えよう。何が変わるかな？",
    "Make a social world": "交流する世界を作る",
    "Add beacons and choose “Follow Maro.” Can you gather the creatures together?": "ビーコンを追加して「マロについていく」を選ぼう。クリーチャーを集められるかな？",
    "What is happening?": "何が起きている？",
    "Clear": "クリア",
    "World Pieces": "世界のパーツ",
    "Plant — grows food": "植物 — 食べ物が実る",
    "Muncher — seeks food and starves after 30 seconds": "マンチャー — 食べ物を探し、30秒食べられないと死ぬ",
    "Drifter — wanders / follows beacons": "ドリフター — 歩き回る・ビーコンを追う",
    "Beacon — attracts drifters": "ビーコン — ドリフターを引き寄せる",
    "Pond — slows moving creatures": "池 — 動くクリーチャーを遅くする",
    "Mini World Ideas": "ミニワールドのアイデア",
    "Close": "閉じる",
    "Balanced Garden": "バランスのよい庭",
    "3 plants, 2 munchers, normal food growth.": "植物3つ、マンチャー2体、普通の成長速度。",
    "Hungry World": "空腹の世界",
    "1 plant, 5 munchers, slow food growth.": "植物1つ、マンチャー5体、遅い成長速度。",
    "Magnet City": "マグネットシティ",
    "4 drifters and 2 beacons with strong beacon pull.": "ドリフター4体とビーコン2つ、強い引く力。",
    "Maro Fan Club": "マロのファンクラブ",
    "Make creatures follow Maro and walk around the stage.": "クリーチャーをマロについてこさせ、ステージを歩き回ろう。",
    "Island World": "島の世界",
    "Use ponds to create slow zones and place food between them.": "池でゆっくり進む場所を作り、その間に食べ物を置こう。",
    "Your Own Experiment": "自分の実験",
    "Build any world, then change exactly one rule and compare.": "好きな世界を作り、ルールを1つだけ変えて比べよう。",
    "World limit reached: remove something before adding more.": "世界がいっぱいです。追加する前に何かを取り除いてください。",
    "World reset. Build something new.": "世界をリセットしました。新しい世界を作ろう。",
    "Surprise rules applied.": "おまかせルールを設定しました。",
    "A plant grew new food.": "植物に新しい食べ物が実りました。",
    "A muncher found food.": "マンチャーが食べ物を見つけました。",
    "A muncher starved after 30 seconds without food.": "マンチャーは30秒間食べられず、死んでしまいました。",
    "World paused.": "世界を一時停止しました。",
    "World running.": "世界が動いています。",
    "World ready. Choose a piece and click the stage.": "世界の準備ができました。パーツを選んでステージを押そう。",

    "Maro's Workshop 2 — Creature Behavior Lab": "マロのワークショップ2 — クリーチャー行動ラボ",
    "ON YOUR CODE · SCENE 05": "オン・ユア・コード・シーン05",
    "Build a tiny creature, give it a rule, and watch it come alive.": "小さなクリーチャーを作り、ルールを与えて、動き出す様子を見よう。",
    "Creature Builder": "クリーチャービルダー",
    "Max 5 creatures": "最大5体",
    "Name": "名前",
    "Body Shape": "からだの形",
    "Round": "丸",
    "Square": "四角",
    ...
    "Antenna": "アンテナ",
    "Crown": "王冠",
    "When Maro is near…": "マロが近くにいるとき…",
    "Follow": "ついていく",
    "Run Away": "逃げる",
    "Orbit": "周りを回る",
    "Freeze": "止まる",
    "Dance": "ダンス",
    "Default Motion": "いつもの動き",
    "Wander": "歩き回る",
    "Bounce": "跳ねる",
    "Patrol": "パトロール",
    "Rest": "休む",
    "Sensitivity Radius": "感度の半径",
    "Movement Speed": "移動の速さ",
    "Rule Preview": "ルールのプレビュー",
    "Release Creature": "クリーチャーを放す",
    "Save Preset": "プリセットを保存",
    "Play Stage": "プレイステージ",
    "Move Maro with arrow keys or WASD. Click a creature to give it a little hop.": "矢印キーまたはWASDでマロを動かせます。クリーチャーを押すと少しジャンプします。",
    "Selected": "選択中",
    "None": "なし",
    "Lab Notes": "ラボノート",
    "Interactive": "インタラクティブ",
    "Try this": "試してみよう",
    "Make one shy creature and one friendly creature. What happens when Maro walks between them?": "恥ずかしがり屋と友好的なクリーチャーを1体ずつ作ろう。マロが間を歩くとどうなるかな？",
    "Observe": "観察",
    "Rules become personality. Changing one rule can make the same creature feel brave, sleepy, or playful.": "ルールが個性になります。1つのルールを変えるだけで、同じクリーチャーが勇敢、眠そう、遊び好きに感じられます。",
    "Create": "作る",
    "Can you build a tiny world with a leader, a dancer, and a guard?": "リーダー、ダンサー、ガードがいる小さな世界を作れるかな？",
    "Preset Library": "プリセットライブラリ",
    "No presets saved yet.": "保存されたプリセットはまだありません。",
    "Live Creatures": "動いているクリーチャー",
    "No creatures released yet.": "まだクリーチャーはいません。",
    "Make a Buddy": "友だちを作る",
    "Create a creature that follows Maro everywhere.": "どこまでもマロについていくクリーチャーを作ろう。",
    "Make a Shy One": "恥ずかしがり屋を作る",
    "Create a creature that runs away whenever Maro comes close.": "マロが近づくたびに逃げるクリーチャーを作ろう。",
    "Make a Performer": "パフォーマーを作る",
    "Create a creature that freezes, then dances when Maro gets near.": "普段は止まり、マロが近づくと踊るクリーチャーを作ろう。",
    "Make a Solar System": "太陽系を作る",
    "Release two orbit creatures with different colors and radii.": "色と半径が違う、周りを回るクリーチャーを2体放そう。",
    "Make a Team": "チームを作る",
    "Release three creatures that all react differently to the same Maro.": "同じマロにそれぞれ違う反応をするクリーチャーを3体放そう。",
    "Make Something Funny": "面白いものを作る",
    "Give a square creature dot eyes, a crown, and a dramatic dance rule.": "四角いクリーチャーに点の目、王冠、大げさなダンスのルールを与えよう。",
    "You can release up to 5 creatures in the lab.": "ラボに放せるクリーチャーは5体までです。",
    "Focus": "選ぶ",
    "Remove": "削除",
    "Load": "読み込む",
    "Spawn": "放す",
    ...
    "Combine sequences, loops, conditions, and creative missions.": "順序、繰り返し、条件分岐を組み合わせ、最後は自分のミッションを作ろう。",
    "ENTER THE LAB": "ラボに入る",
    ...
    "Follow the Colors": "色のルールをたどろう",
    "Conditions + movement": "条件分岐＋移動",
    "Give each color its rule, then let Maro observe the tiles and react on the way to the workshop.": "色ごとのルールを決めて、マロがマスの色を見ながらワークショップまで進めるようにしよう。",
    "A condition lets a program observe what is happening and choose the next action. The same loop can react differently to each color.": "条件分岐を使うと、プログラムは今の状況を見て次の動作を選べます。同じ繰り返しでも、色ごとに違う反応ができます。",
    "Lantern Patrol": "ランタンパトロール",
    "Repeat until": "条件まで繰り返す",
    "Choose the loop that keeps Maro moving, lights every lantern, and stops at the workshop.": "マロが進み続け、すべてのランタンをともして、ワークショップで止まる繰り返しを選ぼう。",
    "REPEAT UNTIL describes the stopping condition, so the route length does not need to be entered manually.": "REPEAT UNTIL は止まる条件を表すので、道の長さを数えて入力する必要がありません。",
    "Repair the Patrol Program": "パトロールプログラムを直そう",
    "Debugging groups": "命令のまとまりをデバッグ",
    "The patrol is stuck. Move one instruction out of the condition so Maro can reach every lantern.": "パトロールが止まっています。命令を1つ条件の外へ動かし、マロがすべてのランタンへ進めるようにしよう。",
    "Indentation groups instructions. When MOVE was inside IF, Maro could only move while already standing on a lantern.": "字下げは命令のまとまりを表します。MOVE が IF の中にあると、マロはランタンの上にいるときしか進めません。",
    "Build a Mission": "ミッションを作ろう",
    "Design a system": "しくみをデザイン",
    "Place Maro, a workshop, at least two lanterns, and optional walls. Build a program, explain your rule, then test your mission.": "マロ、ワークショップ、2つ以上のランタンを置き、必要なら壁も加えよう。プログラムを作ってルールを説明し、ミッションをテストしよう。",
    "You designed the world and the algorithm together. Programming becomes an object to build, test, explain, and improve.": "世界とアルゴリズムを一緒にデザインできました。プログラミングは、作り、試し、説明し、改良できるものになります。",
    "Give all three colors an instruction first.": "最初に3つの色すべてへ命令を決めてください。",
    "That color map sends Maro off the route. Watch the tile where the direction first changes.": "その色のルールではマロが道から外れます。最初に向きが変わるマスを見てみよう。",
    "Choose the patrol program you want to test.": "テストするパトロールプログラムを選んでください。",
    "Maro moved once, but there was no loop to continue the patrol.": "マロは1回進みましたが、パトロールを続ける繰り返しがありません。",
    "Maro reached the workshop, but the lantern condition was missing.": "マロはワークショップに着きましたが、ランタンをともす条件がありません。",
    "MOVE is now part of the loop.": "MOVE が繰り返しの一部になりました。",
    "MOVE is inside IF ON LANTERN.": "MOVE が『ランタンの上なら』の中にあります。",
    "Grouping changed. Test the repair.": "命令のまとまりを変えました。修正をテストしよう。",
    "MOVE returned inside the condition.": "MOVE を条件の中へ戻しました。",
    "Maro is not on a lantern, so the whole IF group is skipped—including MOVE.": "マロはランタンの上にいないため、MOVE を含む IF のまとまり全体が実行されません。",
    "Place Maro": "マロを置く",
    "Place workshop": "ワークショップを置く",
    "Add lantern": "ランタンを追加",
    "Add wall": "壁を追加",
    "Erase": "消す",
    "START FACING": "最初の向き",
    "I planned the route in small steps.": "道順を小さな手順に分けて考えました。",
    "I tested and revised my program.": "プログラムをテストして直しました。",
    "My rule visits every required object.": "必要なものをすべて通るルールにしました。",
    "▶ Test mission": "▶ ミッションをテスト",
    "Place at least two lanterns in your mission.": "ミッションにランタンを2つ以上置いてください。",
    "Build a program before testing the mission.": "ミッションをテストする前にプログラムを作ってください。",
    "Choose the sentence that best explains your design rule.": "デザインしたルールを最もよく説明する文を選んでください。",
    "Mission designed!": "ミッション完成！",
    "Your mission is possible: Maro reached the workshop, every lantern was lit, and you explained the rule behind your design.": "ミッションはクリア可能です。マロはワークショップに着き、すべてのランタンをともして、デザインのルールも説明できました。",
    "Maro hit a wall or the edge. Revise the route or the program, then test again.": "マロが壁か端にぶつかりました。道順またはプログラムを直して、もう一度テストしよう。",
    "Choose a tool, then tap the board to design your mission.": "道具を選び、ボードを押してミッションをデザインしよう。",
    "Colored tiles are instructions: observe the color before moving.": "色のついたマスが命令です。進む前に色を観察しよう。",
    "Lanterns glow when Maro activates them.": "マロが作動させるとランタンが光ります。",
    "Blue turns right, red turns left, and yellow moves twice before the loop's final MOVE.": "青は右、赤は左を向き、黄はループ最後の MOVE の前に2マス進みます。",
    "The loop must contain MOVE and the lantern condition, so both actions repeat until the workshop.": "MOVE とランタンの条件を繰り返しの中に入れ、ワークショップまで両方が続くようにしよう。",
    "MOVE must happen whether or not Maro is standing on a lantern. Change its indentation.": "ランタンの上かどうかに関係なく MOVE が実行されるよう、字下げを変えよう。",
    "Start with a simple route. Place two lanterns along it, then build and test the turns one at a time.": "簡単な道順から始めよう。道の途中にランタンを2つ置き、曲がり方を1つずつ作ってテストしよう。",
    "PROGRAM": "プログラム",
    "COMMANDS": "コマンド",
    ...
    "Well done! Challenge solved.": "よくできました！チャレンジ成功です。",
    "All challenges complete ✓": "すべてのチャレンジ完了 ✓",
  ...
  function translatePattern(value, target) {
    ...
    if ((match = value.match(/^PROGRAM · (\d+)\/20 COMMANDS$/))) return ja ? `プログラム・${match[1]}/20 コマンド` : value;
    if ((match = value.match(/^プログラム・(\d+)\/20 コマンド$/))) return ja ? value : `PROGRAM · ${match[1]}/20 COMMANDS`;
    if ((match = value.match(/^Maro lit (\d+)\/(\d+) lanterns and did not finish correctly\. Change one thing and retest\.$/))) return ja ? `マロはランタンを ${match[1]}/${match[2]} 個ともしましたが、正しくゴールできませんでした。1か所変えてもう一度テストしよう。` : value;
    if ((match = value.match(/^マロはランタンを (\d+)\/(\d+) 個ともしましたが、正しくゴールできませんでした。1か所変えてもう一度テストしよう。$/))) return ja ? value : `Maro lit ${match[1]}/${match[2]} lanterns and did not finish correctly. Change one thing and retest.`;
    if ((match = value.match(/^(Plant|Muncher|Drifter|Beacon|Pond) (added|removed)\.$/))) {
      const thing = { Plant:"植物", Muncher:"マンチャー", Drifter:"ドリフター", Beacon:"ビーコン", Pond:"池" }[match[1]];
      return ja ? `${thing}を${match[2] === "added" ? "追加" : "削除"}しました。` : value;
    }
    if ((match = value.match(/^(植物|マンチャー|ドリフター|ビーコン|池)を(追加|削除)しました。$/))) {
      const thing = { 植物:"Plant", マンチャー:"Muncher", ドリフター:"Drifter", ビーコン:"Beacon", 池:"Pond" }[match[1]];
      return ja ? value : `${thing} ${match[2] === "追加" ? "added" : "removed"}.`;
    }
    if ((match = value.match(/^Day (\d+) begins\.$/))) return ja ? `${match[1]}日目が始まりました。` : value;
    if ((match = value.match(/^(\d+)日目が始まりました。$/))) return ja ? value : `Day ${match[1]} begins.`;
    if ((match = value.match(/^(Garden|Busy|Quiet) preset loaded\.$/))) {
      const name = { Garden:"ガーデン", Busy:"にぎやかな世界", Quiet:"静かな世界" }[match[1]];
      return ja ? `${name}プリセットを読み込みました。` : value;
    }
    if ((match = value.match(/^(ガーデン|にぎやかな世界|静かな世界)プリセットを読み込みました。$/))) {
      const name = { ガーデン:"Garden", にぎやかな世界:"Busy", 静かな世界:"Quiet" }[match[1]];
      return ja ? value : `${name} preset loaded.`;
    }
    if ((match = value.match(/^Creature (\d+)$/))) return ja ? `クリーチャー${match[1]}` : value;
    if ((match = value.match(/^クリーチャー(\d+)$/))) return ja ? value : `Creature ${match[1]}`;
